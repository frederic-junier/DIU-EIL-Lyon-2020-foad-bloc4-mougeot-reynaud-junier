Ce répertoire contient le ressources pour l'atelier pour TP noté sur le profil `admin` de la base (compléter formulaire HTML et code Python de l'application Web).
