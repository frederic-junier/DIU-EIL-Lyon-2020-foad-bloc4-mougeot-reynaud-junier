...
def resultatAppel():
    ...
    def requeteListeAppelClasse(conn, cur, result):
        ...
        ### Récupérer pour un établissement du supérieur
        ### la liste des statuts, noms d'élèves (renommage nomCandidat),  prénoms d'élèves (renommage prenomCandidat)
        ### noms de lycées (renommage nomLycee), moyenne dans l'ordre des moyennes décroissantes
        requete = """ """
